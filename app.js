...
const nunjucks = require('nunjucks'); // 템플릿 엔진 nunjucts 사용
...
app.set('port', process.env.PORT || 8011); // 포트 설정
...
// 라우터가 없는 경우 404 에러를 발생시키는 미들웨어를 추가
...
app.use((err, req, res, next) => {
    res.locals.message = err.messagel; // 에러 메시지를 로컬 변수에 할당 -> 템플릿에서 사용
